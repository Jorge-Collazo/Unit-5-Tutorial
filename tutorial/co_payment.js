...
function validateNumber(){
   ...
   if(cardNumber.validity.valueMissing){
      cardNumber.setCustomValidity("Enter your card umber");
...
function luhn(idNum){
   ...
   //Retrieves the even-numbered digits and doubles them
   for (var i = idNum.length - 2; i >= 0; i-= 2) {
      string2 += 2*idNum.charAt(i);
   }
   //Returns whether the sum of the digits is divisible by 10
